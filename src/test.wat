...
(module
  ...
  (func (export "_start") (local $op1 i64) (local $i i64) (local $one i64) (local $res i64) (local $__v0 i32) 
i64.const 10
local.set $op1
i64.const 0
local.set $i
...
i64.le_s
local.set $__v0
(block $b_loop_750346931677353
        (loop $l_loop_750346931677353
          local.get $res
local.get $i
i64.add
local.set $res
