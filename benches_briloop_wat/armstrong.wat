...
(module
  ...
  (func (export "_start") (param $input i64) (local $zero i64) (local $ten i64) (local $sum i64) (local $digits i64) (local $tmp i64) (local $__v0 i32) (local $b i32) (local $digit i64) (local $pow i64) (local $res i32) 
i64.const 0
local.set $zero
i64.const 10
local.set $ten
...
(func $getDigits (param $n i64) (result i64) (local $ten i64) (local $zero i64) (local $one i64) (local $div i64) (local $cond i32) (local $rec i64) (local $res i64) 
i64.const 10
local.set $ten
i64.const 0
local.set $zero
...
(func $power (param $base i64) (param $exp i64) (result i64) (local $ten i64) (local $zero i64) (local $one i64) (local $res i64) (local $__v2 i32) (local $b i32) 
i64.const 10
local.set $ten
i64.const 0
local.set $zero
