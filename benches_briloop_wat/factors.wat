...
(module
  ...
  (func (export "_start") (param $num i64) (local $zer i64) (local $one i64) (local $fac i64) (local $__v0 i32) (local $ispos i32) (local $quo i64) (local $tmp i64) (local $mod i64) (local $iszero i32) 
i64.const 0
local.set $zer
i64.const 1
local.set $one
