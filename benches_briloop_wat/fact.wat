...
(module
  ...
  (func (export "_start") (param $a i64) (local $x i64) (local $v13 i64) 
local.get $a
call $fact
 local.set $x
local.get $x
...
(func $fact (param $a i64) (result i64) (local $v1 i64) (local $v2 i64) (local $v3 i32) (local $v4 i64) (local $v5 i64) (local $v6 i64) (local $v7 i64) (local $v8 i64) (local $v9 i64) (local $v10 i64) 
local.get $a
local.set $v1
i64.const 0
local.set $v2
