...
(module
  ...
  (func (export "_start") (param $n i64) (local $first i64) (local $second i64) (local $isSame i32) 
local.get $n
call $sum_by_loop
 local.set $first
local.get $n
...
(func $sum_by_loop (param $n i64) (result i64) (local $one i64) (local $sum i64) (local $i i64) (local $__v0 i32) (local $con i32) 
i64.const 1
local.set $one
i64.const 0
local.set $sum
...
i32.const 1
local.set $__v0
(block $b_loop_19652029834897544
        (loop $l_loop_19652029834897544
          local.get $i
local.get $n
i64.le_s
local.set $con
...
br $l_loop_19652029834897544
 ...
 return
          ...
          local.get $__v0
          br_if $l_loop_19652029834897544
        )
      )
i64.const 0
return
 )
(func $sum_by_formula (param $n i64) (result i64) (local $one i64) (local $two i64) (local $n_1 i64) (local $multi i64) (local $sum i64) 
i64.const 1
local.set $one
i64.const 2
local.set $two
