...
(module
  ...
  (func $ack (param $m i64) (param $n i64) (result i64) (local $zero i64) (local $one i64) (local $cond_m i32) (local $tmp i64) (local $cond_n i32) (local $m1 i64) (local $n1 i64) (local $t1 i64) (local $t2 i64) 
i64.const 0
local.set $zero
i64.const 1
local.set $one
...
(func (export "_start") (param $m i64) (param $n i64) (local $tmp i64) 
local.get $m
local.get $n
call $ack
 local.set $tmp
