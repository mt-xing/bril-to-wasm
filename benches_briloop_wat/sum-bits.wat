...
(module
  ...
  (func (export "_start") (param $input i64) (local $sum i64) (local $two i64) (local $zero i64) (local $__v0 i32) (local $cond i32) (local $bit i64) 
i64.const 0
local.set $sum
i64.const 2
local.set $two
...
(func $mod (param $dividend i64) (param $divisor i64) (result i64) (local $quotient i64) (local $two i64) (local $prod i64) (local $diff i64) 
local.get $dividend
local.get $divisor
i64.div_s
local.set $quotient
