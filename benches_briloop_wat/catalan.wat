...
(module
  ...
  (func (export "_start") (param $input i64) (local $catn i64) 
local.get $input
call $catalan
 local.set $catn
local.get $catn
...
(func $catalan (param $n i64) (result i64) (local $one i64) (local $zero i64) (local $guard0 i32) (local $sum i64) (local $idx i64) (local $__v0 i32) (local $guard1 i32) (local $n2 i64) (local $v1 i64) (local $v2 i64) (local $elti i64) 
i64.const 1
local.set $one
i64.const 0
local.set $zero
...
i32.const 1
local.set $__v0
(block $b_loop_5311114714638816
        (loop $l_loop_5311114714638816
          local.get $idx
local.get $n
i64.le_s
local.set $guard1
