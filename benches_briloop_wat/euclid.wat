...
(module
  ...
  (func (export "_start") (local $v0 i64) (local $x i64) (local $v1 i64) (local $y i64) (local $v2 i64) (local $v3 i64) (local $f i64) (local $v4 i64) (local $v5 i64) 
i64.const 23789216
local.set $v0
local.get $v0
local.set $x
i64.const 1748698766
local.set $v1
local.get $v1
local.set $y
local.get $x
...
(func $mod (param $r i64) (param $s i64) (result i64) (local $v0 i64) (local $v1 i64) (local $v2 i64) (local $v3 i64) (local $v4 i64) (local $v5 i64) (local $v6 i64) (local $result i64) (local $v7 i64) 
local.get $r
local.set $v0
local.get $r
local.set $v1
...
(func $gcd (param $a i64) (param $b i64) (result i64) (local $v0 i64) (local $zero i64) (local $v1 i64) (local $v2 i64) (local $v3 i32) (local $cond_temp i32) (local $v4 i32) (local $cond i32) (local $__v0 i32) (local $v6 i32) (local $v7 i64) (local $temp i64) (local $v8 i64) (local $v9 i64) (local $v10 i64) (local $v11 i64) (local $v12 i64) (local $v13 i64) (local $v14 i32) (local $v15 i32) (local $v16 i64) 
i64.const 0
local.set $v0
local.get $v0
local.set $zero
...
i32.const 1
local.set $__v0
(block $b_loop_6139098488937149
        (loop $l_loop_6139098488937149
          local.get $cond
local.set $v6
local.get $v6
 (if
