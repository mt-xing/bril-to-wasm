...
i32.const 1
local.set $__v0
(block $b_loop_9333961450613761
        (loop $l_loop_9333961450613761
          local.get $m
local.set $v8
i64.const 0
local.set $v9
...
local.get $v10
 (if
       (then 
 (block $block_025741670110155157
        local.get $m
local.set $v12
local.get $m
local.set $v13
