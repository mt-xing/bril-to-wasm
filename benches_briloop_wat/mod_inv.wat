...
(module
  ...
  (func (export "_start") (param $n i64) (param $p i64) (local $v0 i64) (local $two i64) (local $v1 i64) (local $v2 i64) (local $v3 i64) (local $m i64) (local $v4 i64) (local $ans i64) (local $v5 i64) (local $a i64) (local $v7 i64) (local $i i64) (local $__v0 i32) (local $v8 i64) (local $v9 i64) (local $v10 i32) (local $v12 i64) (local $v13 i64) (local $v14 i64) (local $v15 i64) (local $v16 i64) (local $v17 i64) (local $v18 i32) (local $v19 i64) (local $v20 i64) (local $v21 i64) (local $v22 i64) (local $v23 i64) (local $v24 i64) (local $v25 i64) (local $v26 i64) (local $v27 i64) (local $v28 i64) (local $v29 i64) (local $v30 i64) (local $v31 i64) (local $v32 i64) (local $v33 i64) 
i64.const 2
local.set $v0
local.get $v0
local.set $two
...
i32.const 1
local.set $__v0
(block $b_loop_17244083842034308
        (loop $l_loop_17244083842034308
          local.get $m
local.set $v8
i64.const 0
local.set $v9
...
return
          ...
          local.get $__v0
          br_if $l_loop_17244083842034308
        )
      )
 )
(func $mod (param $n i64) (param $p i64) (result i64) (local $v0 i64) (local $v1 i64) (local $v2 i64) (local $v3 i64) (local $v4 i64) (local $v5 i64) (local $v6 i64) 
local.get $n
local.set $v0
local.get $n
local.set $v1
