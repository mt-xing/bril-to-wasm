...
i32.const 1
local.set $__v0
(block $b_loop_3298896443675303
        (loop $l_loop_3298896443675303
          local.get $i
local.set $v3
local.get $n
local.set $v4
...
i32.const 1
local.set $__v4
(block $b_loop_2527447165523179
        (loop $l_loop_2527447165523179
          local.get $i
local.set $v7
local.get $x
local.set $v8
