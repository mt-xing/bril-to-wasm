...
(module
  ...
  (func (export "_start") (param $x i64) (local $one i64) (local $two i64) (local $three i64) (local $__v0 i32) (local $eq_one i32) (local $half i64) (local $doublehalf i64) (local $even i32) 
i64.const 1
local.set $one
i64.const 2
local.set $two
...
local.get $two
i64.mul
local.set $doublehalf
local.get $x
local.get $doublehalf
i64.eq
local.set $even
local.get $even
 (if
