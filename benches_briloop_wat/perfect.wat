...
i32.const 1
local.set $__v0
(block $b_loop_909684152543778
        (loop $l_loop_909684152543778
          local.get $i
local.get $i
i64.mul
local.set $ii
...
i64.add
local.set $i
br $l_loop_909684152543778
 
) 
)

          local.get $__v0
          br_if $l_loop_909684152543778
        )
      )
 )
