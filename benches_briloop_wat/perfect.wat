...
(module
  ...
  (func (export "_start") (param $input i64) (local $n i64) (local $v0 i64) (local $v1 i64) (local $v2 i64) (local $sum i64) (local $i i64) (local $result i64) (local $__v0 i32) (local $ii i64) (local $comp i32) (local $comp2 i32) (local $qut i64) (local $mpt i64) (local $dif i64) (local $comp1 i32) 
local.get $input
local.set $n
i64.const 0
local.set $v0
...
i32.const 1
local.set $__v0
(block $b_loop_5363065405073325
        (loop $l_loop_5363065405073325
          local.get $i
local.get $i
i64.mul
local.set $ii
...
i64.add
local.set $i
br $l_loop_5363065405073325
 
) 
)

          local.get $__v0
          br_if $l_loop_5363065405073325
        )
      )
 )
