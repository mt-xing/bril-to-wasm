...
i32.const 1
local.set $__v0
(block $b_loop_5905052678112411
        (loop $l_loop_5905052678112411
          (block $block_12032817053846134
        local.get $v0
local.get $v1
i64.lt_s
local.set $v2
