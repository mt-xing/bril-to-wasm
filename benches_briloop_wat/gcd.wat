...
(module
  ...
  (func (export "_start") (param $op1 i64) (param $op2 i64) (local $vc0 i64) (local $v0 i64) (local $v1 i64) (local $__v0 i32) (local $v2 i32) (local $v3 i64) (local $v4 i32) 
i64.const 0
local.set $vc0
local.get $op1
local.set $v0
...
i32.const 1
local.set $__v0
(block $b_loop_7382558009919103
        (loop $l_loop_7382558009919103
          (block $block_43947942176814714
        local.get $v0
local.get $v1
i64.lt_s
local.set $v2
