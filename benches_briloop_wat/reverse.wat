...
(module
  ...
  (func (export "_start") (param $input i64) (local $n i64) (local $v0 i64) (local $v1 i64) (local $result i64) (local $v2 i32) (local $notdone i32) (local $__v0 i32) (local $v4 i32) (local $v5 i64) (local $a i64) (local $floor i64) (local $remainder i64) (local $comp1 i32) 
local.get $input
local.set $n
i64.const 0
local.set $v0
