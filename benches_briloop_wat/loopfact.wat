...
(module
  ...
  (func (export "_start") (param $input i64) (local $value i64) (local $v1 i64) (local $result i64) (local $v3 i64) (local $i i64) (local $__v0 i32) (local $v4 i64) (local $v5 i64) (local $v6 i32) (local $v7 i64) (local $v8 i64) (local $v9 i64) (local $v10 i64) (local $v11 i64) (local $v12 i64) (local $v13 i64) (local $v14 i64) 
local.get $input
local.set $value
i64.const 1
local.set $v1
