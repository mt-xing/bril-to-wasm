(module
  ...
  (func (export "_start")
    ;; Test i64 integer printing
    i64.const 123456789012345 ;; Changed to i64.const
    call $int_to_string_and_print
    call $print_newline

    i64.const -67890123456789 ;; Changed to i64.const
    call $int_to_string_and_print
    call $print_newline
    ...
    i64.const 9223372036854775807 ;; i64.MAX_INT
    call $int_to_string_and_print
    call $print_newline

    i64.const -9223372036854775808 ;; i64.MIN_INT
    call $int_to_string_and_print
    call $print_newline
